...
**NOTE:** Bicycle servers also implement [server reflection](https://github.com/grpc/grpc/blob/master/doc/server-reflection.md), so you can also roll over to your preferred gRPC desktop client (i.e Postman), type in `0.0.0.0::50051`, and it will automatically load up all your available RPCs.
